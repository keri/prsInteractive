...
plink --bfile  "${DATA_PATH}"/variant_calls/ukb22418_c6_b0_v2 --pheno "${PHENO_PATH}"/pheno.txt --exclude-snps nullA_26-nullA_28 --keep "${PHENO_PATH}"/combinedID.txt --remove "${DATA_PATH}"/withdrawalsID.txt --geno .05 --maf .0001 --hwe .00005  --make-bed --out  "${PHENO_PATH}"/chr6_cleaned
