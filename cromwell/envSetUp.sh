...
# Create a .env file for future reference
cat > "$PROJECT_ROOT/pheno.config" << EOF
...
echo "[WORKFLOW] PHENOTYPE PATH is set to: $PROJECT_ROOT/$pheno"
echo "[PHENO] PHENO is set to: $pheno"
echo "[WORKFLOW] OUTPUT SCORES directory: $PROJECT_ROOT/$pheno/scores"
echo "[WORKFLOW] OUTPUT MODELS directory:: $PROJECT_ROOT/$pheno/models"
echo "[WORKFLOW] OUTPUT EPI RESULTS directory:: $PROJECT_ROOT/$pheno/epiFiles"
echo "[WORKFLOW] OUTPUT PHENO FIGURES directory:: $PROJECT_ROOT/$pheno/figures"
