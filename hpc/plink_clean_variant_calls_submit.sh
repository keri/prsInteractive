#!/bin/bash
#
#SBATCH --job-name=clean_variant_calls_tanigawa
#SBATCH -o /nfs/scratch/multerke/ukbiobank/err_out/%A_cleanedChromosomeTestTanigawa.out
#SBATCH -e /nfs/scratch/multerke/ukbiobank/err_out/%A_cleanedChromosomeTestTanigawa.err
